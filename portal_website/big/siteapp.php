...
<!-- START LEFT COL -->
        <p>Responsive web sites and native mobile apps are two approaches used by individuals or institutions to supply web content to mobile devices. However there are several key differences between the two approaches. In the article “Responsive Website vs Mobile App: Comparison”
        Korol points out that one major distinction between the two is that responsive websites are used by companies to make their services, information, or goods available on various platforms. Responsive websites are available to everyone regardless of operating system and do not require the user to download or install anything(Korol). They also don't require the user to update anything, and no additional support is required either. Also responsive websites are "less expensive [and], [y]ou don’t have to create native [mobile] apps for each type of mobile phones and tablets when you have one responsive website. It also makes maintenance cost lower and working with SEO gets easier”(Korol).</p>
        <br>
